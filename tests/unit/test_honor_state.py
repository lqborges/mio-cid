...
class TestHonorMeters(unittest.TestCase):
    ...
    def test_hud_scenes_exist_and_are_colorblind(self) -> None:
        ...
        self.assertIn("func gloss_texts(", meters)
        self.assertIn("GlossOnores", meters)
        self.assertIn("func _ensure_captions", meters)
        self.assertIn("func _get_tooltip", plazo)
        self.assertIn("locale_changed", plazo)
        self.assertIn("hud.plazo", plazo)
        self.assertIn("func caption_text(", plazo)
        self.assertIn('name = "Caption"', plazo)
        self.assertNotIn('"plazo"', plazo)
        packed_meters = _read("game/ui/honor_meters.tscn")
        self.assertIn("GlossOnores", packed_meters)
        self.assertIn("text = \"feudos\"", packed_meters)
        self.assertIn("text = \"rey\"", packed_meters)
        self.assertIn("text = \"nombre\"", packed_meters)
        packed_plazo = _read("game/ui/plazo_bar.tscn")
        self.assertIn('name="Caption"', packed_plazo)
        self.assertIn('text = "Plazo"', packed_plazo)
