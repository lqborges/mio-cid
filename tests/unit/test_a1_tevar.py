...
class TestA1TevarTableColada(unittest.TestCase):
    ...
    def test_world_script_battle_capture_eat(self) -> None:
        ...
        self.assertIn("reset_swords", menu)
        poyo = _read("content/chapters/a1_poyo/world.gd")
        self.assertIn("goto", poyo)
        self.assertIn("current_scene != self", poyo)
